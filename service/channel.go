...
func DisableChannel(channelError types.ChannelError, reason string) {
	...
	success := false
	if channelError.IsMultiKey && channelError.MultiKeyIndex >= 0 {
		success = model.UpdateChannelStatusAtKeyIndex(channelError.ChannelId, channelError.MultiKeyIndex, common.ChannelStatusAutoDisabled, reason)
	} else {
