...
import (
	...
	"github.com/QuantumNous/new-api/custom/conversationaudit"
...
func SetApiRouter(router *gin.Engine) {
	conversationaudit.RegisterWebRoutes(router)
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/recharge-center", controller.GetRechargeCenterSetting)
		...
		subscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			...
			subscriptionAdminRoute.PUT("/users/:id/access-groups", controller.AdminSetUserSubscriptionAccessGroups)
		...
		conversationaudit.Register(apiRouter)
	}
}
