...
export function CommonLogsFilterBar<TData>(
  ...
  const searchState = useMemo<CommonLogDraft>(() => {
    ...
    const sourceValues = {
      ...
      excludeUsername: searchParams.excludeUsername,
    ...
    const filters: CommonLogFilters = {
      ...
      excludeUsername: searchParams.excludeUsername || undefined,
  ...
  const expandedFilterCount = [
    ...
    isAdmin ? filters.excludeUsername : undefined,
  ...
  const advancedFilters = (
    <>
      ...
      {isAdmin && (
        <LogsFilterField>
          <LogsFilterInput
            placeholder={t('Exclude Username')}
            type={sensitiveType}
            value={filters.excludeUsername || ''}
            onChange={(e) => handleChange('excludeUsername', e.target.value)}
            onKeyDown={handleKeyDown}
          />
        </LogsFilterField>
      )}
